...
public class add_newAdmin extends AppCompatActivity {
    ...
    public void init_date() {
        ...
        dateBttn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDatePicker = new DatePickerDialog(add_newAdmin.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void backPressed(){
        backBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(add_newAdmin.this, Admin_activity.class ));
            }
        });
    }
...
//     backgroundTask.execute(first1,last1,gender,day1,address1,emailaddress1,user,password,role);
            ...
            try {
                ...
                String data_string = URLEncoder.encode("username","UTF-8")+"="+URLEncoder.encode(username12,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("role","UTF-8")+"="+URLEncoder.encode("admin","UTF-8")+"&"+
        ...
        protected void onPostExecute(String result) {
            ...
            if(error.equals("Error.")){
                ...
                startActivity(new Intent(add_newAdmin.this, login_page.class));
