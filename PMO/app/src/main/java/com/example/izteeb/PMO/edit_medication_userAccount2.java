...
public class edit_medication_userAccount2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        mTimePicker = new TimePickerDialog(edit_medication_userAccount2.this,
    ...
    public void spinnerSet(){
        ...
        intervalSpinner.setOnItemSelectedListener(edit_medication_userAccount2.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(edit_medication_userAccount2.this, android.R.layout.simple_spinner_item,intervalCategories);
    ...
    public void initDatePicker() {
        ...
        date12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(edit_medication_userAccount2.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void back(View view){
        startActivity(new Intent(edit_medication_userAccount2.this, chooseSlotForEdit.class));

    }
    public void cancel(View view){
        startActivity(new Intent(edit_medication_userAccount2.this, user_activity.class));
    ...
    public class loadMedicationInformation extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(edit_medication_userAccount2.this);
