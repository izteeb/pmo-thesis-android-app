...
public class edit_medication extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    String userCurrent, slotSP, amOrpm;
    int minTime, hourTime, minInt, hourInt, slotSP_int = 2;
    int minQuantity=0;
    int minDosage=0;
    ...
    EditText medName, dosageEdit, quantityEdit, descEdit;
    TextView dosage,timeText,minText,ampmText, dayText, monthText, yearText, slot, user1;
    TimePickerDialog mTimePicker;
    ProgressDialog pDialog;
    Spinner intervalSpinner;

    String userIntent, slotIntent, intervalItem, interval2, desc2;
    ...
    public void spinnerSet(){
        ...
        intervalSpinner.setOnItemSelectedListener(edit_medication.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(edit_medication.this, android.R.layout.simple_spinner_item,intervalCategories);
    ...
    public void timeBttnClicked(){
        ...
        time12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mTimePicker.setTitle("Slot "+slotIntent+": Set Alarm Time");
                mTimePicker.show();
            }
        });
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        mTimePicker = new TimePickerDialog(edit_medication.this,
    ...
    public void initDatePicker() {
        ...
        date12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(edit_medication.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void back(View view){
        startActivity(new Intent(edit_medication.this, edit_userslotMedication.class));

    }
    public void cancel(View view){
        startActivity(new Intent(edit_medication.this, Admin_activity.class));
    ...
    public void saveButtonClicked(){
        ...
        done1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(descEdit.getText().toString().isEmpty() || medName.getText().toString().isEmpty() || dosageEdit.getText().toString().isEmpty()
            ...
            if (jsonString != null) {
                try {
                    ...
                    for (int i = 0; i < jarray.length(); i++) {
                        ...
                        if (user.equals(userIntent) && slot == Integer.parseInt(slotIntent)) {
                            min2 = min;
                            hour2 = hour;
                            ampm2 = am_pm;
                            quantity2 = quantity;
    ...
    class saveMedication extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(edit_medication.this);
            pDialog.setMessage("Updating slot"+ slotIntent+" information...");
        ...
        protected String doInBackground(String... args) {
            ...
            String username2, slot2,med2,dosage2,min2,hour2,ampm2,day2,month2,year2, interval2, desc2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userIntent = getIntent().getStringExtra("medUserEdit");
        slotIntent = getIntent().getStringExtra("medSlotEdit");
        slot.setText(slotIntent);
