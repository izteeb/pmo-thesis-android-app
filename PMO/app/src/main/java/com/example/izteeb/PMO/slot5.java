...
public class slot5 extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void findView() {
        ...
        time12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mTimePicker.setTitle("Slot 5: Set Alarm Time");
                mTimePicker.show();
            }
        });
    ...
    public void spinnerSet(){
        ...
        intervalSpinner.setOnItemSelectedListener(slot5.this);
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(slot5.this, android.R.layout.simple_spinner_item,intervalCategories);
    ...
    private void openTimePickerDialog(boolean is24r) {
        ...
        mTimePicker = new TimePickerDialog(slot5.this,
    ...
    public void init_date() {
        ...
        date12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mDatePicker = new DatePickerDialog(slot5.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void back(View view){
        startActivity(new Intent(slot5.this, chooseSlot.class));

    }
    public void cancel(View view){
        startActivity(new Intent(slot5.this, user_activity.class));
...
//     backgroundTask.execute(first1,last1,gender,day1,address1,emailaddress1,user,password,role);
            ...
            try {
                ...
                String data_string = URLEncoder.encode("medicine_name","UTF-8")+"="+URLEncoder.encode(medName2,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("slot_number","UTF-8")+"="+URLEncoder.encode("5","UTF-8")+"&"+
